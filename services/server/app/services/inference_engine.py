...
class InferenceEngine:
    @classmethod 
    async def calculate_flood_probability(cls, db_client: "DatabaseClient", weather_data: dict, sensor_data: dict, device_id: str) -> Classification:
        ...
        # dh/dt
        prev_height = await cls._get_previous_height(db_client, device_id)
        ...
        return Classification.SAFE # Hardcode
    
    @staticmethod
    async def _get_previous_height(db_client: "DatabaseClient", device_id: str) -> float:
